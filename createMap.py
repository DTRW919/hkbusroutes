        ...
        if abs(lat2 - lat1) <= 0.05 and abs(lon2 - lon1) <= 0.05:
            if fileObject["features"][j + 1]["properties"]["stopSeq"] - fileObject["features"][j]["properties"]["stopSeq"] == 1:
                ...
                plotLine(
                    lat1, lon1,
                    lat2, lon2,
                    setData(fileObject["features"][j]["properties"]["routeNameE"], "color"),
                    fileObject["features"][j]["properties"]["routeNameE"],
                    setData(fileObject["features"][j]["properties"]["routeNameE"], "layer")
                )
